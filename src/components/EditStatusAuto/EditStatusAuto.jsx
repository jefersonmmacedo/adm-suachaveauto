...
export function EditStatusAuto({id}) {

    const {updateStatusAuto} = useContext(AuthContext);
    ...
    function handleOpenModalSearch(e) {
        ...
        function handleUptadeAvailability() {
            updateStatusAuto({id, availability});
            setIsOpenModaSearch(false);
        }
         ...
         <Modal isOpen={isOpenModalSearch} onRequestClose={handleCloseModalSearch}
            ...
            <div className="form">
                    ...
                    <div className="TypeButtons">
                        ...
                        <button className={availability === "Reservado" ? "btnType4Select" : "btnType2Select"} onClick={() => handleNewType("Reservado")}><IoSyncOutline />Reservado</button>
