...
export function NewChargeAuto() {
    const Local = localStorage.getItem("adm-suachaveauto");
    const user = JSON.parse(Local);

    const {NewChargeAuto, newFeature} = useContext(AuthContext);
    ...
    async function AutoInfoLoaded(data) {
        ...
        await api.get(`/Auto/${data}`).then((res) => {
            console.log(data)
            setId(data)
    ...
    return (
        <div className="NewChargeAuto">
            ...
            <h4>Dados do encargo</h4>
                    ...
                    <button className="btnSendContract" onClick={handleNewChargeAuto}>Cadastrar novo encargo11902</button>
                    </div>
