...
export function NewAuto() {
    
    const Local = localStorage.getItem("adm-suachaveauto");
    const user = JSON.parse(Local);

    const {newAuto, newFeature, newLicensing} = useContext(AuthContext);
    ...
    return (
        <div className="NewAuto">
            ...
            <h4>Vídeo</h4>
                    ...
                    <button className="btnSend" onClick={handleNewAuto}>Cadastrar anúncio</button>
